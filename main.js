...
var author$project$Page$Home$homePage = {
	content: _List_fromArray(
		[
			A2(
			elm$html$Html$p,
...
var author$project$Page$NotFound$notFoundPage = {
	content: _List_fromArray(
		[
			A2(
			elm$html$Html$p,
...
var author$project$Main$view = function (model) {
	var page = function () {
		...
		switch (_n0.$) {
			case 'Home':
				return author$project$Page$Home$homePage;
			case 'About':
				return author$project$Page$About$aboutPage;
			default:
				return author$project$Page$NotFound$notFoundPage;
		}
	}();
	return {
		body: _Utils_ap(
